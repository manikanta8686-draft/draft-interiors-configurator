...
function App() { const location = useLocation(); return <><Navbar /><AnimatePresence mode="wait"><Routes location={location} key={location.pathname}><Route path="/" element={<PageMotion><Home /></PageMotion>} /><Route path="/sofas" element={<PageMotion><Collection /></PageMotion>} /><Route path="/configurator" element={<PageMotion><ErrorBoundary fallback={<ErrorState title="The configurator is resting." message="Refresh the page or contact our design team. Your saved configurations remain safe." />}><Suspense fallback={<LoadingState label="Preparing your atelier..." />}><Configurator /></Suspense></ErrorBoundary></PageMotion>} /><Route path="/about" element={<PageMotion><About /></PageMotion>} /><Route path="/contact" element={<PageMotion><Contact /></PageMotion>} /><Route path="/admin" element={<PageMotion><ErrorBoundary fallback={<ErrorState title="The sales office is unavailable." message="Refresh the page or check that the secure admin server is running." />}><Suspense fallback={<LoadingState label="Opening the private sales office..." />}><AdminDashboard /></Suspense></ErrorBoundary></PageMotion>} /><Route path="*" element={<PageMotion><NotFound /></PageMotion>} /></Routes></AnimatePresence></>; }
export default App;
