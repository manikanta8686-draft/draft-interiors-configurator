...
export default function EnquiryForm({
  ...
  return <form className="enquiry-form" onSubmit={submit}>
    ...
    <label>Tell us a little more<textarea required name="message" minLength="10" maxLength="2000" value={message} onChange={(event) => setMessage(event.target.value)} placeholder="I'd like to create a sofa for..." rows="4" /></label>
